...
class ViewController: UIViewController {
    ...
    func startNavigation(styles: [MapboxNavigation.Style]) {
        ...
        let options = NavigationOptions(styles: styles, navigationService: navigationService(route: route, routeIndex: 0, options: routeOptions), predictiveCacheLocationOptions: PredictiveCacheLocationOptions())
    ...
    func startGuidanceCardsNavigation() {
        ...
        let options = NavigationOptions(navigationService: navigationService(route: route, routeIndex: 0, options: routeOptions), topBanner: instructionsCardCollection, predictiveCacheLocationOptions: PredictiveCacheLocationOptions())
        let navigationViewController = NavigationViewController(for: route, routeIndex: 0, routeOptions: routeOptions, navigationOptions: options)
        navigationViewController.delegate = self
    ...
    func navigationViewController(navigationService: NavigationService) -> NavigationViewController {
        let navigationOptions = NavigationOptions(navigationService: navigationService, predictiveCacheLocationOptions: PredictiveCacheLocationOptions())
