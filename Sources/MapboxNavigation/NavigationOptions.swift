...
open class NavigationOptions: NavigationCustomizable {
     ...
     */
    open var predictiveCacheLocationOptions: PredictiveCacheLocationOptions?
    ...
    /**
     ...
     - parameter predictiveCacheLocationOptions: Predictive Caching setup.
     */
    public convenience init(styles: [Style]? = nil, navigationService: NavigationService? = nil, voiceController: RouteVoiceController? = nil, topBanner: ContainerViewController? = nil, bottomBanner: ContainerViewController? = nil, predictiveCacheLocationOptions: PredictiveCacheLocationOptions? = nil) {
        self.init()
        self.styles = styles
        ...
        self.predictiveCacheLocationOptions = predictiveCacheLocationOptions
    }
